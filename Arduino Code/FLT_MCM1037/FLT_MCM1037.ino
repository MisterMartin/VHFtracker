...
#define PRE_MSG   "1037_PRE"   // Flight name in APRS preflight mode message
#define TRK_MSG   "1037_TRK"   // Flight name in APRS track mode message (sent every TRACK_APRS_TX_PERIOD)
#define TRK_GPS   "1037_GPS"   // Flight name in APRS track mode GPS message (sent every TRACK_GPS_PERIOD)
#define PING_ID 37             // Value (0-255)sent for ping Identification byte (last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 24 June 2019, Julian Day 175, Wake Up Date: 16 Nov 2019, Julian Day 320 -----------
#define HIBERNATE_PERIOD 145     // Will Hibernate for 320-175 = 145 days
