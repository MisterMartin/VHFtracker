...
#define FLIGHT_PERIOD 240              // How many minutes to be in active flight mode before sleeping
#define FLIGHT_APRS_TX_PERIOD 10       // How often to send an APRS position in minutes in flight mode

// Mode 1 (Hibernate) parameter
#define HIBERNATE_PERIOD 171       // How many days to sleep before beginning transmission
...
void setup()
{
  ...
  delay(500);  
  broadcastLocation( "TRACKER_ON_FLT" ); // XMT Tracker ON message to the radio
  delay(500);
}
