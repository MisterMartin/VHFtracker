...
#define PRE_MSG   "1036_PRE"   // Flight name in APRS preflight mode message
#define TRK_MSG   "1036_TRK"   // Flight name in APRS track mode message (sent every TRACK_APRS_TX_PERIOD)
#define TRK_GPS   "1036_GPS"   // Flight name in APRS track mode GPS message (sent every TRACK_GPS_PERIOD)
#define PING_ID 36             // Value (0-255)sent for ping Identification byte (last two digits of the flight number)
