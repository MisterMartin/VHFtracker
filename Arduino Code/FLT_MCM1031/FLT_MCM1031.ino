...
#define PRE_MSG   "1031_PRE"   // Flight name in APRS preflight mode message
#define TRK_MSG   "1031_TRK"   // Flight name in APRS track mode message (sent every TRACK_APRS_TX_PERIOD)
#define TRK_GPS   "1031_GPS"   // Flight name in APRS track mode GPS message (sent every TRACK_GPS_PERIOD)
#define PING_ID 31             // Value (0-255)sent for ping Identification byte (last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 29 May 2019, Julian Day 149, Wake Up Date: 1 Nov 2019, Julian Day 305 -----------
#define HIBERNATE_PERIOD 156       // Will Hibernate for 305-149 = 156 days
