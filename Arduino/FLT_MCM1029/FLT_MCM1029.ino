...
// Launch Date: Wednesday, 1 May 2019
...
#define FLIGHT_NAME "MCM1029"      //Flight name in APRS message

// Mode 0 (Flight) parameters
#define FLIGHT_PERIOD 60              // How many minutes to be in active flight mode before sleeping
#define FLIGHT_APRS_TX_PERIOD 10      // How often to send an APRS position in minutes in flight mode

// Mode 1 (Hibernate) parameter
#define HIBERNATE_PERIOD 184       // How many days to sleep before beginning transmission (wake up 1 Nov 2019)

// Mode 2 (Track) parameters
#define TRACK_APRS_TX_PERIOD 15    // How often to send APRS position in minutes in track mode
#define TRACK_GPS_PERIOD 24        // How often to look for a GPS position in hours in track mode
#define TRACK_PING_TX_PERIOD 15    // how often to send a 'beep' in seconds
#define PING_DURATION 1000         // How long the ping transmission is in msec (time = PING_DURATION/10)
...
void setup()
{
  ...
  delay(500);  
  broadcastLocation( "TRACKER_ON_MODE=FLT" ); // XMT Tracker ON message to the radio
  delay(500);
}
