...
#define PRE_MSG   "1033_PRE"   // Flight name in APRS preflight mode message
#define TRK_MSG   "1033_TRK"   // Flight name in APRS track mode message (sent every TRACK_APRS_TX_PERIOD)
#define TRK_GPS   "1033_GPS"   // Flight name in APRS track mode GPS message (sent every TRACK_GPS_PERIOD)
#define PING_ID 33             // Value (0-255)sent for ping Identification byte (last two digits of the flight number)
