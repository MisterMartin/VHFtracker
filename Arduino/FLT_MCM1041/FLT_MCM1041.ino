...
#define FLIGHT_NUM "1041"             // MUST be 4 numeric characters, .e.g. "1030"
#define PING_ID    41                 // Ping ID (0-255) sent for ping ID byte (should be last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 05 April 2023 (JD 95), Wake Up Date: 01 Nov 2023(JD 305) -----------
#define HIBERNATE_PERIOD        210   // Will Hibernate for 320-94 = 210 days
