...
#define FLIGHT_NUM "1042"             // MUST be 4 numeric characters, .e.g. "1030"
#define PING_ID    42                 // Ping ID (0-255) sent for ping ID byte (should be last two digits of the flight number)
