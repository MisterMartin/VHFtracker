...
#define PRE_MSG   "1034_PRE"   // Flight name in APRS preflight mode message
#define TRK_MSG   "1034_TRK"   // Flight name in APRS track mode message (sent every TRACK_APRS_TX_PERIOD)
#define TRK_GPS   "1034_GPS"   // Flight name in APRS track mode GPS message (sent every TRACK_GPS_PERIOD)
#define PING_ID 34             // Value (0-255)sent for ping Identification byte (last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 8 June 2019, Julian Day 159, Wake Up Date: 16 Nov 2019, Julian Day 320 -----------
#define HIBERNATE_PERIOD 161      // Will Hibernate for 320-159 = 161 days
