...
#define FLIGHT_NUM "1040"             // MUST be 4 numeric characters, .e.g. "1030"
#define PING_ID    40                 // Ping ID (0-255) sent for ping ID byte (should be last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 03 April 2023 (JD 93), Wake Up Date: 01 Nov 2023(JD 305) -----------
#define HIBERNATE_PERIOD        212   // Will Hibernate for 320-88 = 212 days
