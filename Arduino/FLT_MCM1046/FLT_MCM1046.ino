...
#define FLIGHT_NUM "1046"             // MUST be 4 numeric characters, .e.g. "1030"
#define PING_ID    46                 // Ping ID (0-255) sent for ping ID byte (should be last two digits of the flight number)
...
// HIBERNATE parameters --- Launch Date: 27 April 2023 (JD 117), Wake Up Date: 01 Nov 2023 (JD 305)-----------
#define HIBERNATE_PERIOD        188   // Will Hibernate for 188 days
